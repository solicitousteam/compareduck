...
<head>
		...
		<!-- owl.carousel css -->
		<link rel="stylesheet" href="{{URL::asset('front_assets/css/owl.carousel.css')}}">
		<link rel="stylesheet" href="{{URL::asset('front_assets/css/owl.transitions.css')}}">
       <!-- Animate css -->
        <link rel="stylesheet" href="{{URL::asset('front_assets/css/animate.css')}}">
        <!-- meanmenu css -->
        <link rel="stylesheet" href="{{URL::asset('front_assets/css/meanmenu.min.css')}}">
		<!-- font-awesome css -->
		<link rel="stylesheet" href="{{URL::asset('front_assets/css/font-awesome.min.css')}}">
		<link rel="stylesheet" href="{{URL::asset('front_assets/css/themify-icons.css')}}">
		<link rel="stylesheet" href="{{URL::asset('front_assets/css/flaticon.css')}}">
		<!-- magnific css -->
        <link rel="stylesheet" href="{{URL::asset('front_assets/css/magnific.min.css')}}">
		<!-- style css -->
		...
		<!-- modernizr css -->
		<script src="{{URL::asset('front_assets/js/vendor/modernizr-2.8.3.min.js')}}"></script>
		<style>
		    .logo a h2{
		        color:#fff;
		    }
                    ...
                    <div class="row">
                       <div class="col-md-6 col-sm-6">
                           <div class="topbar-left">
                                <ul>
                                    <li><a href="mailto:info@compareduck.com"><i class="fa fa-envelope"></i> info@compareduck.com</a></li>
                                    <li><a href="#"><i class="fa fa-phone"></i> +91 788 828 6744</a></li>
                                </ul>
							</div>
                        </div>
                        ...
                        <div class=" col-md-6 col-sm-6">
                            <div class="topbar-right">
                                <div class="top-social">
                                    <ul>
                                        <!--<li><a href="https://join.skype.com/invite/tgETiWcZC9gL"><i class="fa fa-skype"></i></a></li>-->
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="row">
                             ...
                             <div class="logo">
                                        <!-- Brand -->
                                      <a href="{{url('/')}}"><h2>Compareduck</h2></a>
                                    </div>
                                    <!-- logo end -->
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mobile-menu">
                                <div class="logo">
                                                  <a href="{{url('/')}}"><span>Compareduck</span></a>
                                </div>
                                <nav id="dropdown">
                           <ul>
                                        <li><a class="pages" href="{{url('/')}}">Home</a>
