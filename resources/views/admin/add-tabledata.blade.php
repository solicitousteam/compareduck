...
<form class="row g-3 " action="addtabledata" method="post"  enctype="multipart/form-data" i="myform">
@csrf
<div class="col-md-12">
...
<div class="col-md-6">
<label  class="form-label">Sub Category</label>
<select name="subcategoryy" id="subcategoryy" value="{{old('subcategory')}}" class="form-control single-select">
<option value="">--Select Subcategroy type--</option>
</select> 
...
<input type="text" name="title" value="{{old('quantity')}}" class="form-control" >
</div>


<div class="col-md-6">
<label  class="form-label">Image</label>
<input type="file" name="image" value="{{old('quantity')}}" class="form-control" >
</div>
